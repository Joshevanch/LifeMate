...
CREATE TABLE RECORD (id serial primary key, recorddate timestamptz not null default NOW(), height integer not null, weight integer not null, weeklytodolist integer not null, userhelp integer not null, achievement integer not null, selfreward integer not null, obesity integer not null, stress float not null);
